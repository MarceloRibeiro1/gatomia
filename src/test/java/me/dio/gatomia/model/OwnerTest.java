...
class OwnerTest {
    ...
    @Test
    void setNameNull() {
        AppInvalidModelException thrownNull = assertThrows(AppInvalidModelException.class, () -> owner.setName(null));
        assertEquals("Name is required", thrownNull.getMessage());
    }

    @Test
    void setNameEmpty() {
        AppInvalidModelException thrownEmpty = assertThrows(AppInvalidModelException.class, () -> owner.setName(""));
